 ...
 */
abstract class BaseTestsForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'writing'     => new sfWidgetFormInputText(),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorAnd(array(
        new sfValidatorDoctrineUnique(array('model' => 'Tests', 'column' => array('name'))),
        new sfValidatorDoctrineUnique(array('model' => 'Tests', 'column' => array('slug'))),
      ))
    );
