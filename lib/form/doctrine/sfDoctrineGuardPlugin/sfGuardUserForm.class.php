...
class sfGuardUserForm extends PluginsfGuardUserForm {
    ...
    public function configure() {
        ...
        unset($this['activephone'],$this['activephonecode'],$this['oldphone'],$this['ssidentity'], $this['algorithm'], $this['username'], $this['salt'], $this['is_active'], $this['is_super_admin'], $this['last_login'], $this['last_ip'], $this['personal_recomendation'], $this['groups_list'], $this['permissions_list'], $this['cart']);
