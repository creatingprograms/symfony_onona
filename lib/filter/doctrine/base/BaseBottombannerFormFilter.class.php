...
/**
 * Bottombanner filter form base class.
 *
 * @package    test
 * @subpackage filter
 ...
 */
abstract class BaseBottombannerFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('bottombanner_filters[%s]');
