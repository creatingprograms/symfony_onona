...
/**
 * ActionsDiscount filter form base class.
 *
 * @package    test
 * @subpackage filter
 ...
 */
abstract class BaseActionsDiscountFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('actions_discount_filters[%s]');
