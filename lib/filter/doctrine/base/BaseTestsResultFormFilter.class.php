...
/**
 * TestsResult filter form base class.
 *
 * @package    test
 * @subpackage filter
 ...
 */
abstract class BaseTestsResultFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tests_result_filters[%s]');
