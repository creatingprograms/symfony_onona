...
class sfWidgetFormDoctrineChoiceSearchArray extends sfWidgetFormChoice {
    ...
    protected function configure($options = array(), $attributes = array()) {
        ...
        $this->addRequiredOption('choises');
    ...
    public function getChoices() {
        ...
        foreach ($this->getOption('choises') as $id => $object) {
            $choices[$id] = $object['name'];
        }
        return $choices;
    }
