...
<td class="sf_admin_boolean sf_admin_list_td_is_public_<?php echo $product->getId() ?>">
    ...
    if (sfContext::getInstance()->getUser()->hasPermission("SEO Параметры")):
        ?>
        <?php echo get_partial('product/list_field_boolean', array('value' => $product->getIsPublic())) ?>
        <?php
    else:
        ?>
    ...
    ?></td>
<td class="sf_admin_boolean sf_admin_list_td_is_related_<?php echo $product->getId() ?>"><?php
    if (sfContext::getInstance()->getUser()->hasPermission("SEO Параметры")):
        ?>
        <?php echo get_partial('product/list_field_boolean', array('value' => $product->getIsRelated())) ?>
        <?php
    else:
        ?>
...
<td class="sf_admin_boolean sf_admin_list_td_adult_<?php echo $product->getId() ?>"><?php
    if (sfContext::getInstance()->getUser()->hasPermission("SEO Параметры")):
        ?>
        <?php echo get_partial('product/list_field_boolean', array('value' => $product->getAdult())) ?>
        <?php
    else:
        ?>
