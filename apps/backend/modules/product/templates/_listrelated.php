            ...
            $(document).ready(function() { 
                $("#productsTable").tableDnD(
                {
                    ...
                    onDrop: function(table, row) 
                    {
                        ...
                        {
                            type: "POST",
                            url: "/backend_dev.php/product/sortChangerelated",
        ...
        <table cellspacing="0" id="productsTable">
            <thead>
                <tr>
                    ...
                    <?php include_partial('product/list_th_tabular', array('sort' => array("positionrelated"))) ?>
            ...
            <tbody>
                <?php $t=0; foreach ($pager->getResults() as $i => $product): $odd = fmod(++$i, 2) ? 'odd' : 'even'; $t++ ?>
                    <tr class="sf_admin_row <?php echo $odd ?>" id="<?= $product->getId() ?>" title="<?= $product->get("positionrelated") ?>">
                        <td><?=$t?></td>
