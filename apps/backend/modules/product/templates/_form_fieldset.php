...
<script language="javascript">
    $(document).ready(function() {
        function startSort(){
            //$('.sf_admin_form_field_Photoalbums div div table tbody tr td table tbody tr td table').each(function(i){if(i==5) $(this).addClass("PhotosTable");});
  ...
  $(this).find("#product_Photoalbums_0_Photos_"+i+"_position").parent().parent().css("display","none");
                        ...
                        $(".PhotosTable").tableDnD(
                        {
                            ...
                            onDrop: function(table, row) 
                            {
                                ...
                                {
                                    type: "POST",
                                    url: "/backend_dev.php/product/photosSortChange",
                                    timeout: 30000,
...
<fieldset id="sf_fieldset_<?php echo preg_replace('/[^a-z0-9_]/', '_', strtolower($fieldset)) ?>">
    ...
    <?php foreach ($fields as $name => $field): ?>
        ...
        <?php
        include_partial('product/form_field', array(
            'name' => $name,
