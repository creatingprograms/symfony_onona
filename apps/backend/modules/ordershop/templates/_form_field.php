                        ...
                        foreach ($products_old as $key => $productInfo):
                            ...
                            if ($product) {
                                ...
                                <tr style="border-top: 1px dotted #AAA">
                                    ...
                                    <td width="50" align="center" style="text-align: center;border: 1px solid #666;"><div style="display: inline-block;" id="totalcost_<?= $productInfo['productId'] ?>"><?= $productInfo['quantity'] * $productInfo['price'] ?></div> р.</td>
                                </tr>
                                <?php
                                unset($product);
                            }else{
