  ...
  <div class="sitemap-wrapper">
    <ul class="pink">
      <li>
    	...
    	<li>
    		<a href="/adresa-magazinov-on-i-ona-v-moskve-i-mo">Адреса магазинов в Москве и МО</a></li>
    	<li>
      ...
      <li>
    		<a href="/manufacturers">Бренды</a></li>
      <li>
    		<a href="/size-table">Таблица соответствия размеров</a></li>
      <li>
    		<a href="/akcii-i-bonusy">Акции и Бонусы</a></li>
    	<li>
        ...
        <ul class="pink black">
          ...
          foreach ($categorys as $row): ?>
            ...
            <?php if ($row['catid'] != $currentCatalog){
              echo '<li><a href="/catalog/'.mb_strtolower($row['catslug']).'">'. $row['catname'].' '.$row['catdescription'].'</a><ul class="pink grey">';
              $currentCatalog=$row['catid'];
            }?>
            <li><a href="/category/<?=mb_strtolower($row['slug'])?>"><?=$row['name']?></a></li>
