<?
  $h1="Лидеры продаж ".$catalog->getName(). " " . $catalog->getDescription();
  ...
  slot('canonical', '/catalog/'.$catalog->getSlug().'/relatecategory' );
  slot('breadcrumbs', [
    ...
    <div class="cat-list-wrap">
      ...
      <?php if ($pager->haveToPaginate()):?>
        <? include_component("noncache", "pagination", array(
          'pager' => $pager,
          'sortingUrl' => '',
          'baselink' => '/catalog/'.$catalog->getSlug().'/relatecategory',
          'show_more' => true,
          'numbers' => true,
        )); ?>
      <?php endif; ?>
