<?php   slot('metaTitle', "Карта сайта"); ?>
<div class="info-box">
  <h1 class="title" style="text-align: center;">Карта сайта</h1>
</div>
<div id="pageShow" class="shopPage">
  <ul>
    <li>
    ...
    <li>
  	...
  	<li>
  		<a href="http://club.onona.ru/">Наш форум</a></li>
  	<li>
  	...
  	<li>
        ...
        foreach ($categorys as $row): ?>
          ...
          <?php if ($row['catid'] != $currentCatalog){
            echo '<li><a href="/catalog/'.$row['catslug'].'">'. $row['catname'].' '.$row['catdescription'].'</a><ul>';
