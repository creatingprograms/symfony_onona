...
if ($product->getId() != ""):
    ...
    ?><li <?
    if (!$last) {
        echo "style=\"border-right: 1px  solid #e0e0e0; white-space: normal;\"";
    }
    ?> class="prodTable-<?= $product->getId() ?> <?php if ($product->getCount() == 0): ?> liProdNonCount<?php endif; ?>">
        ...
        <div class="c">
            <div class="content<?php if ($product->getCount() == 0): ?> notcount<?php endif; ?>"<?php if ($product->getCount() == 0): ?> style="opacity: 0.3;"<?php endif; ?>>
                ...
                <div class="bottom-box">
                    <div class="row">
                        <? if ($commentsCount > 0) { ?><a href="/product/<?= $product->getSlug() ?>/?comment=true#comments" class="rewiev">Отзывы: <?= $commentsCount ?></a><? } ?>
                        <div class="stars">
        ...
        <div class="preShowProduct-<?= $product->getId() ?>">
            <div  class="preShowProduct">
                <ul class="item-list" style="padding: 0px;"><li style="border:0px;padding: 0px;">
                        <div class="c">
                            <div class="content contentPreShowProduct-<?= $product->getId() ?><?php if ($product->getCount() == 0): ?> notcount<?php endif; ?>"<?php if ($product->getCount() == 0): ?> style="opacity: 0.3;"<?php endif; ?>>
                                <?
