            ...
            <table width="450" cellspacing="0" cellpadding="3" border="0">
                <tbody><tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="cName" class="input required" style="width:300px;" value="<?= $cName ?>"></td>
                    </tr>
                    <tr>
                        <td width="100">E-mail</td>
                        <td><input type="text" name="cEmail" class="input" style="width:300px;" value="<?= $cEmail ?>"></td>
                    </tr>
                    <tr>
                        <td width="100">Сообщение</td>
                        <td><?if($errorTxt){?>
                            <span style="font-size: 10px;color: red;">Ошибка. Не должно быть пустым.</span>
                            <br /><?}?><textarea style="width:300px; overflow:auto; border:1px solid #999;" class="required" rows="5" name="cComment" value=""><?= $cComment ?></textarea></td>
                    </tr><tr>
                        <td width="100">
                            Введите символы*
                        </td>
...
<?php else: ?>
    ...
    <a href="/sexopedia/<?= $article->getSlug() ?>">Вернуться к просмотру статьи.</a>
<?php endif; ?>