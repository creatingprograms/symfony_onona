...
$.widget("ui.selectmenu", {
	_init: function() {
		...
		this.newelement.width( (o.width) ? o.width*1.5 : selectWidth*1.5);
	...
	_refreshPosition: function(){	
		...
		//set top value
		var menuTop = (this.newelement.offset().top+6);
                //console.log(this.list.css('top'));
