...
$(document).ready(function () {
    ...
    $(".blockSettingNotification input.datepicker").click(function () {
        tempID = $(this).attr("id");
        $(this).removeAttr("id");
    ...
    function goTime() {
        var SelectDateString = $(".blockSettingNotification input.datepicker").val();
        var SelectDateArray = SelectDateString.split(".");
        //console.log(SelectDateArray[1]);
        SelectDateArray[1] = SelectDateArray[1] - 1;
        if (SelectDateArray[1] !== undefined)
            if (SelectDateArray[1][0] == "0") {
                SelectDateArray[1] = SelectDateArray[1][1];
            }
        date.setDate(1);
        day = date.getDate();
        ...
        for (var i = 1; i <= daysNum; i++) {
            ...
            } else if (i == SelectDateArray[0] && month == SelectDateArray[1] && year == SelectDateArray[2]) {
                days += '<a href="#" class="onSelect" id="day' + i + '"><span>' + i + '</span></a>';
            } else {
